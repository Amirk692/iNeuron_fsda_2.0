...
CREATE OR REPLACE TABLE AM_SALES 
(
  ...
  CREATE OR REPLACE TABLE  AM_SALES_COPY LIKE  AM_SALES;
  
  
  INSERT INTO AM_SALES
VALUES
('A', '2021-01-01', '1'),
('A', '2021-01-01', '2'),
('A', '2021-01-07', '2'),
...
DESCRIBE TABLE AM_SALES;

DESCRIBE TABLE AM_SALES_COPY;

SELECT * FROM AM_SALES;

SELECT * FROM AM_SALES_COPY;
